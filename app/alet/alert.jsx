          ...
          {(onClose) => (
            <>
              ...
              <ModalBody>
                ...
                <p>
                📢 Attention: <b>Due to high demand</b>,we can not take more orders right now. Existing orders might take up to 10 days for processing. We appreciate your patience and understanding. Thank you! 🙏
                </p>
              </ModalBody>
              <ModalFooter>
